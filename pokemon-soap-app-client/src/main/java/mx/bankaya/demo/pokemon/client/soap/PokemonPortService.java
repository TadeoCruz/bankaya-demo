 ...
 * 
 */
@WebServiceClient(name = "PokemonPortService", targetNamespace = "http://bankaya.mx/demos/web-service", wsdlLocation = "file:/home/tcruz/workspaces/demos/pokemon-soap-app-client/src/main/resources/pokemon.wsdl")
    ...
    extends Service
{
    ...
    private final static QName POKEMONPORTSERVICE_QNAME = new QName("http://bankaya.mx/demos/web-service", "PokemonPortService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("file:/home/tcruz/workspaces/demos/pokemon-soap-app-client/src/main/resources/pokemon.wsdl");
    ...
    public PokemonPort getPokemonPortSoap11() {
        return super.getPort(new QName("http://bankaya.mx/demos/web-service", "PokemonPortSoap11"), PokemonPort.class);
    }
    ...
    public PokemonPort getPokemonPortSoap11(WebServiceFeature... features) {
        return super.getPort(new QName("http://bankaya.mx/demos/web-service", "PokemonPortSoap11"), PokemonPort.class, features);
    }
